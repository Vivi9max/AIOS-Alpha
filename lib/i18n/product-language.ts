 ...
 *
 * AIOS localization is not literal translation.
 *
 ...
 *
 * Locale goals:
 * - English: native professional SaaS / AI product language
 * - Simplified Chinese: native professional Chinese product language
 * - Japanese: native professional Japanese software / SaaS language
 *
...
/**
 * Get canonical product wording for a locale.
 */
...
/**
 * Narrow corrections for legacy hard-coded UI.
 *
 * IMPORTANT:
 * These corrections are intended only for known product UI phrases.
 * User-generated content must never be passed through this map.
 *
 * The map intentionally contains only phrases known to be mechanically
 * translated or semantically inferior in the legacy UI.
 */
