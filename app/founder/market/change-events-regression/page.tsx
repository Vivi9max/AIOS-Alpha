...
export default function MarketChangeEventsRegressionPage() {
  const [
    sessionReady,
    setSessionReady,
  ] = useState(false);
  ...
  async function runRegression() {
    ...
    try {
      const response =
        await fetch(
          "/api/founder/market/change-events-regression",
          {
            method:
              "GET",
            cache:
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          C147.13 Market Change Event Regression
        </h1>
        <div
          style={{
            opacity:
        ...
        >
          C147.13.1 · Detect → Event → Preserve History
        </div>
        {!sessionReady && (
          <section
            style={{
        ...
        {sessionReady && (
          ...
          >
            ...
            >
              C147.13.1 validates the real event runtime
        ...
        {result && (
          ...
          >
            ...
            >
              ...
              >
                C147.13 only converts C147.12 detection
                results into structured events. It does not
                mutate history, create Tasks, dispatch Planner
                work, rank securities, predict outcomes,
