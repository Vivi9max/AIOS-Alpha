...
export async function GET(
  ...
  try {
    ...
    /*
     * Phase 1:
     * Execute C147.18 and verify that
     ...
     *
     * C147.15 performs the actual persistence.
     */
    const decision =
      await runMarketRiskReassessmentHumanReview(
        {
    ...
    /*
     * Phase 3:
     * Attempt a second decision.
     * C147.15 must block it.
     */
    const duplicate =
      await runMarketRiskReassessmentHumanReview(
        {
    ...
    const checks = [
...

      {
        ...
        passed:
          persistedBeforeDecision ===
          null,

        detail:
          "No human decision was inferred during task creation.",
      },
...

      {
        ...
        passed:
          ...
          duplicate.existingReview?.decision ===
            "accepted",
    ...
    return NextResponse.json(
      {
        ...
        principles: [
          "C147.18 remains the upstream risk-reassessment engine.",
          "C147.19 creates the persistent human-review Task.",
          "C147.15 remains the only persistence path for an explicit human decision.",
          "A human decision is never inferred.",
          "Existing decisions remain immutable.",
